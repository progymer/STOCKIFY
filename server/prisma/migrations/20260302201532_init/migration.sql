...
CREATE TABLE "Prodicts" (
    ...
    CONSTRAINT "Prodicts_pkey" PRIMARY KEY ("productId")
);
...
-- AddForeignKey
ALTER TABLE "sales" ADD CONSTRAINT "sales_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Prodicts"("productId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "purchases" ADD CONSTRAINT "purchases_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Prodicts"("productId") ON DELETE RESTRICT ON UPDATE CASCADE;
